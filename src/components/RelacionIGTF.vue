    ...
    <div class="fit row justify-center">
      <div class="col-12 q-py-md">
        <q-card flat bordered class="cards" id="impresion">
          <div class="row">
            <div class="col-10">
              <h6 class="q-my-md q-ml-md">RELACION IGTF</h6>
            </div>
  ...
  data() {
    ...
    const columns_facturas = [
      ...
      },
      {
        ...
        align: "left",
        field: (row) => {
          return "Resumen diario ret IGTF";
        },
        format: (val) => `${val}`,
        sortable: true,
      },
      {
        ...
        align: "left",
        field: (row) => {
          return row.facturas + " facturas";
        },
        format: (val) => `${val}`,
        sortable: true,
      },
      {
        name: "totalBaseImponibleBolivares",
        required: true,
        label: "Base imponible",
        align: "left",
        field: (row) => row.totalBaseImponibleBolivares.toLocaleString("de-DE"),
        format: (val) => `${val}`,
        sortable: true,
      },
    ];
