    ...
    <div class="fit row justify-center">
      <div class="col-12 q-py-md">
        <q-card flat bordered class="cards" id="impresion">
          <div class="row">
            <div class="col-10">
              <h6 class="q-my-md q-ml-md">CIERRE DE CAJA CONSOLIDADO</h6>
            </div>
          ...
          <div class="row">
            <div class="col-12">
              <p class="q-ml-md text-subtitle1">
                ...
                <template v-if="this.data.primera_factura.numero_factura">
                  | Primera factura
                  <span class="text-bold">
                    {{ this.data.primera_factura.numero_factura }}
                  </span>
                </template>

                <template v-else>
                  | Primera orden trabajo:
                  <span class="text-bold">
                    {{ this.data.primera_factura.orden_trabajo }}
                  </span>
                </template>

                <template v-if="this.data.segunda_factura.numero_factura">
                  | Ultima factura
                  <span class="text-bold">
                    {{ this.data.segunda_factura.numero_factura }}
                  </span>
                </template>

                <template v-else>
                  | Ultima orden trabajo:
                  <span class="text-bold">
            ...
            <div class="col-12 q-px-md">
              <q-card class="my-card">
                ...
                <div class="row q-ml-md q-pb-md">
                  ...
                  <div class="col">
                    <div class="row">
                      <div class="col-12 text-bold">Total facturas</div>
                      <div class="col-12">
                        {{ this.data.monto_total_facturas_bolivares }}
                        BsF
                      </div>
                      <!----<div class="col-12">
                ...
                <div class="row q-ml-md q-pb-md">
                  ...
                  <div class="col">
                    <div class="row">
                      <div class="col-12 text-bold">OT a contado</div>
                      <div class="col-12">
                        {{ this.data.total_bolivares_ordenes_trabajo_contado }}
                        BsF
                      </div>
                      <!---<div class="col-12">
                        {{ this.data.total_pesos_ordenes_trabajo }} COP
                      </div>
                      <div class="col-12">
                        {{ this.data.total_dolares_ordenes_trabajo }} USD
                      </div>-->
                      <div class="col-12">-</div>
                      <!--<div class="col-12">-</div>
                      <div class="col-12">-</div>-->
                      <div class="col-12">
                        <q-separator />{{
                          this.data.total_ordenes_trabajo_contado
                        }}
                      </div>
                    </div>
                  </div>
                  <div class="col">
                    <div class="row">
                      <div class="col-12 text-bold">OT a credito</div>
                      <div class="col-12">
                        {{ this.data.creditoBOT }}
                        BsF
                      </div>
                      <!----<div class="col-12">
                        {{
                      ...
                      <div class="col-12">
                        <q-separator />{{
                          this.data.cantidad_ordenes_trabajo_credito
                        }}
                      </div>
                    </div>
                  </div>
                  <div class="col">
                    <div class="row">
                      ...
                      <div class="col-12">
                        <q-separator />{{
                          this.data.cantidad_facturas_con_descuento
                        }}
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col">
                    <div class="row">
                      <div class="col-12 text-bold">Facturas y OT anuladas</div>
                      <div class="col-12">
                        {{ this.data.factura_anulada_bolivares }} BsF
                      </div>
                      <!----<div class="col-12">
                  ...
                  <div class="col">
                    <div class="row">
                      <div class="col-12 text-bold">Total OT</div>
                      <div class="col-12">
                        {{
                          this.data.ganancia_orden_trabajo_contado_bolivares +
                          this.data.creditoBOT
                        }}
                        BsF
                      </div>
            ...
            <div class="col-4 q-pl-md">
              <q-card class="my-card">
                ...
                <div class="row q-mx-md q-pb-sm">
                  <div class="col-6">
                    <div class="row">
                      <div class="col-12">Efectivo BsF</div>
                      <div class="col-12">Efectivo USD</div>
                      <div class="col-12">Efectivo COP</div>
                      <div class="col-12">Bancolombia</div>
                      <div class="col-12">Transf. Zelle</div>
                      <div class="col-12">Transf. PayPal</div>
                      <div class="col-12">Transferencia BsF</div>
                ...
                <div class="row q-mx-md q-pb-sm">
                  <div class="col-6">
                    <div class="row">
                      ...
                      <div class="col-12">IGTF USD débito</div>
                      <div class="col-12">IGTF USD transferencia</div>
                      <div class="col-12"><q-separator /> Total abonos</div>
                    </div>
                  </div>
                  <div class="col-6">
                    <div class="row text-right">
                      <div class="col-12">
                        {{
                          this.data.abonos_bolivares_efectivo +
                          this.data.efectivoBOTCredito
                        }}
                        BsF
                      </div>
                      <div class="col-12">
                        {{
                          this.data.abonos_dolares_efectivo +
                          this.data.efectivoDOTCredito
                        }}
                        USD
                      </div>
                      <div class="col-12">
                        {{
                          this.data.abonos_pesos_efectivo +
                          this.data.efectivoPOTCredito
                        }}
                        COP
                      </div>
                      <div class="col-12">
                        {{
                          this.data.bancolombiaFacturaCredito +
                          this.data.bancolombiaOTCredito
                        }}
                        COP
                      </div>
                      <div class="col-12">
                        {{
                          this.data.zelleFacturaCredito +
                          this.data.zelleOTCredito
                        }}
                        USD
                      </div>
                      <div class="col-12">
                        {{
                          this.data.paypalFacturaCredito +
                          this.data.paypalOTCredito
                        }}
                        USD
                      </div>
                      <div class="col-12">
                        {{
                          this.data.total_transBancos_factura_credito +
                          this.data.total_transBancos_OTC
                        }}
                        BsF
                      </div>
                      <div class="col-12">
                        {{
                          this.data.total_debitoBancos_factura_credito +
                          this.data.total_debitoBancos_OTC
                        }}
                        BsF
                      </div>
                      <div class="col-12">
                        {{
                          this.data.total_creditoBancos_factura_credito +
                          this.data.total_creditoBancos_OTC
                        }}
                        BsF
                      </div>
                      <div class="col-12">
                      ...
                      <div class="col-12">
                        <q-separator />{{ this.totalesCredito }}
                        BsF
                      </div>
                    </div>
                  </div>
                ...
                <div class="row q-mx-md q-pb-sm">
                  <div class="col-6">
                    <div class="row">
                      ...
                      <div class="col-12">IGTF USD transferencia</div>
                      <div class="col-12">
                        <q-separator /> Total ingresos + abonos
                      </div>
                    </div>
                  </div>
                  <div class="col-6">
                    <div class="row text-right">
                      ...
                      <div class="col-12">
                        {{
                          this.data.ganancia_transferencia_bancolombia +
                          this.data.bancolombiaOTCredito
                        }}
                        COP
                      </div>
                      <div class="col-12">
                        {{
                          this.data.ganancia_transferencia_zelle +
                          this.data.zelleOTCredito
                        }}
                        USD
                      </div>
                      <div class="col-12">
                        {{
                          this.data.ganancia_transferencia_paypal +
                          this.data.paypalOTCredito
                        }}
                        COP
                      </div>
                ...
                <div class="row q-ml-md q-pb-md">
                  <div class="col">
                    <div class="row text-bold">
                      ...
                      <div class="col-12">100% Banco</div>
                      <div class="col-12">Totales</div>
                    </div>
                  </div>
                  <div class="col">
                    <div class="row">
                      ...
                      <div class="col-12">
                        {{
                          ...
                          this.data.debitoProvincialOTCredito
                        }}
                        BsF
                      </div>
                      <div class="col-12">
                        {{
                          ...
                          this.data.debitoSofitasaOTCredito
                        }}
                        BsF
                      </div>
                      <div class="col-12">
                        {{
                          ...
                          this.data.debitoMercantilOTCredito
                        }}
                        BsF
                      </div>
                      <div class="col-12">
                        {{
                          ...
                          this.data.debitoBanescoOTCredito
                        }}
                        BsF
                      </div>
                      <div class="col-12">
                        {{
                          ...
                          this.data.debitoVenezuelaOTCredito
                        }}
                        BsF
                      </div>
                      <div class="col-12">
                        {{
                          this.data.ganancia_debito_100_banco +
                          this.data.debito100BancoOTCredito
                        }}
                        BsF
                      </div>
                      <div class="col-12">
                    ...
                    <div class="row">
                      ...
                      <div class="col-12">
                        {{
                          ...
                          this.data.creditoProvincialOTCredito
                        }}
                        BsF
                      </div>
                      <div class="col-12">
                        {{
                          ...
                          this.data.creditoSofitasaOTCredito
                        }}
                        BsF
                      </div>
                      <div class="col-12">
                        {{
                          ...
                          this.data.creditoMercantilOTCredito
                        }}
                        BsF
                      </div>
                      <div class="col-12">
                        {{
                          ...
                          this.data.creditoBanescoOTCredito
                        }}
                        BsF
                      </div>
                      <div class="col-12">
                        {{
                          ...
                          this.data.creditoVenezuelaOTCredito
                        }}
                        BsF
                      </div>
                      <div class="col-12">
                        {{
                          this.data.ganancia_credito_100_banco +
                          this.data.credito100BancoOTCredito
                        }}
                        BsF
                      </div>
                      <div class="col-12">
                  ...
                  <div class="col">
                    <div class="row">
                      ...
                      <div class="col-12">
                        {{ this.data.ganancia_transferencia_100_banco }} BsF
                      </div>
                      <div class="col-12">
                        {{
                          this.data.ganancia_transferencia_provincial +
                          this.data.ganancia_transferencia_100_banco +
                          this.data.ganancia_transferencia_sofitasa +
                          this.data.ganancia_transferencia_mercantil +
                          this.data.ganancia_transferencia_banesco +
                          this.data.ganancia_transferencia_venezuela +
                          this.data.ganancia_transferencia_100_banco
                        }}
                        BsF
                      </div>
                  ...
                  <div class="col">
                    <div class="row">
                      ...
                      <div class="col-12">
                        {{ this.data.sumatoria_total_100_banco }} BsF
                      </div>
                      <div class="col-12">
                        {{
                          this.data.sumatoria_total_provincial +
                          this.data.sumatoria_total_100_banco +
                          this.data.sumatoria_total_sofitasa +
                          this.data.sumatoria_total_mercantil +
                          this.data.sumatoria_total_banesco +
                          this.data.sumatoria_total_venezuela +
                          this.data.sumatoria_total_100_banco
                        }}
                        BsF
                      </div>
            ...
            <div class="col-12 q-px-md">
              <q-card class="my-card">
                ...
                <div class="row q-ml-md">
                  <div
                    class="col-12 q-mb-xs"
                    v-for="factura in this.data.facturas_con_descuento"
                    :key="factura.id_factura"
                  >
                    <template v-if="factura.numero_factura">
                      <span class="text-bold">Factura:</span>
                      {{ factura.numero_factura }}&nbsp;
                    </template>
                    <template v-else>
            ...
            <div class="col-12 q-px-md">
              <q-card class="my-card">
                ...
                <div class="row q-ml-md">
                  <div
                    class="col-12 q-mb-xs"
                    v-for="factura in this.data.notas_a_credito"
                    :key="factura.id_factura"
                  >
                    <span class="text-bold">Nota a credito:</span>
                    {{ factura.nota_credito_numero }}&nbsp;
                    <span class="text-bold">Factura:</span>
                    {{ factura.numero_factura }}&nbsp;
                    <span class="text-bold">Cliente:</span>
                    {{ factura.cliente_nombre }}
                  ...
                  <q-card class="my-card q-ml-sm">
                    <div class="row q-ml-md q-pt-md q-pb-sm">
                      ...
                      <div class="col-12">
                        ...
                        <span class="text-bold"
                          >{{ this.data.factura_anulada_bolivares }} BsF</span
                        >
                      </div>
                      <div class="col-12">
                        Total ingresos:
                        <span class="text-bold"
                          >{{
                            this.data.total_factura_contado +
                            this.data.IGTF_bolivares +
                            this.data
                              .sumatoria_bolivares_factura_credito_particulares +
                            this.data
                              .sumatoria_bolivares_factura_credito_convenio +
                            this.data.creditoBOTParticular
                          }}
                          BsF</span
                        >
                      </div>
...
export default {
  ...
  data() {
    ...
    let acceso = ref(null);
    let totalConDevoluciones = Number(
      Math.round(
        this.data.total_factura_contado +
          this.data.sumatoria_bolivares_factura_credito_particulares +
          this.data.sumatoria_bolivares_factura_credito_convenio +
          //this.data.ganancia_factura_credito_bolivares +
          //this.data.total_factura_credito +
          this.data.IGTF_bolivares +
          this.data.factura_anulada_bolivares +
          "e+2"
      ) + "e-2"
    );
    let totalFacturasOT = Number(
      Math.round(
        this.data.monto_total_facturas_bolivares +
          this.data.ganancia_orden_trabajo_contado_bolivares +
          this.data.creditoBOT +
    ...
    let totalesCredito= Number(
      Math.round(
        this.data.total_factura_credito +
          this.data.total_ordenes_trabajo_credito +
          "e+2"
      ) + "e-2"
    );
